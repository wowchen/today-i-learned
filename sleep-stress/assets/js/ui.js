...
(function(){
  ...
  SLP.toggleTheme=function(){
    var cur=document.documentElement.getAttribute('data-theme')||'light';
    applyTheme(cur==='dark'?'light':'dark');
    syncBtn();
  };
  SLP.initTheme=initTheme;
  SLP.syncThemeBtn=syncBtn;

  /* 月牙 + 星点 logo */
  SLP.icons={
    logo:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M16.5 3.6a8.6 8.6 0 1 0 4.2 14.8A9.6 9.6 0 0 1 16.5 3.6z"/><path d="M19 4.4v3M17.5 5.9h3"/></svg>',
