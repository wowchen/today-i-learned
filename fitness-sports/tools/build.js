...
const MODULES = [
  ...
  ['injury','损伤与防护','POLICE 急救、常见损伤、重返训练','实用','Injury Care'],
  ['special','特殊人群','中老年、女性、青少年、慢病人群','实用','Special Groups'],
...
const TERMS = [
  ...
  ['police','POLICE 原则','POLICE Protocol','急性软组织损伤五步处理:保护Protection/适当负荷Optimal Loading/冰敷Ice/加压Compression/抬高Elevation。','伤后急救五步口诀。','injury'],
  ['protection','保护','Protection','停止运动、避免伤处再次受力,必要时用支具固定。','先止损。','injury'],
  ['optimal-loading','适当负荷','Optimal Loading','在不引发疼痛的范围内尽早恢复活动,替代长期完全静养。','伤处也怕闲。','injury'],
  ['ice','冰敷','Ice','急性期用冰袋隔着毛巾冷敷15-20分钟,收缩血管减轻肿胀疼痛。','给组织降温刹车。','injury'],
  ['compression','加压','Compression','用弹性绷带由远端向近端适度缠绕,限制肿胀。','给组织一个温柔的拥抱。','injury'],
  ['elevation','抬高','Elevation','把患处抬到高于心脏的位置,利用重力帮助消肿回流。','让肿胀顺流而下。','injury'],
  ['runner-knee','跑步膝','Runner\u0027s Knee','髌骨周围或外侧的渐进性疼痛,多因臀腿力量不足与负荷递增过快。','膝盖的罢工通知。','injury'],
  ['itb','髂胫束','Iliotibial Band','沿大腿外侧延伸到膝盖的一条致密筋膜,过劳摩擦会引发外侧痛。','大腿外侧的橡皮筋。','injury'],
  ['ankle-sprain','崴脚','Ankle Sprain','踝关节内翻导致外侧韧带拉伤或撕裂,处理不当易反复发作。','最常见的运动伤。','injury'],
  ['balance-training','平衡训练','Balance Training','单腿站立、软垫站立等练习,重建关节本体感觉与稳定性。','脚踝和跌倒的保险。','injury'],
  ['red-flag','红旗症状','Red Flags','提示需立即就医的危险信号,如放射痛、麻木、夜间痛醒、大小便异常。','身体的警报灯。','injury'],
  ['core-training','核心训练','Core Training','强化腹部腰背深层肌群的训练,如平板、鸟狗式、死虫式。','给脊柱配安全带。','injury'],
  ['rotator-cuff','肩袖','Rotator Cuff','包绕稳定肩关节的四块小肌腱,易因肌力失衡被挤压劳损。','肩关节的安全带。','injury'],
  ['impingement','肩峰下撞击','Subacromial Impingement','抬臂时肩袖肌腱在肩峰下窄缝中被挤压摩擦引发疼痛。','肩缝里夹了电线。','injury'],
  ['return-to-play','重返训练','Return to Play','伤后按无痛-有力-有信心三阶段逐步恢复训练的过程。','伤后的回归路线图。','injury'],
  ['ten-percent','10% 原则','10% Rule','每周训练量增幅控制在10%以内,给组织适应与重建的窗口。','进步的安全阀门。','injury'],
  ['sarcopenia','肌少症','Sarcopenia','随年龄增长的肌肉量与力量流失,30岁后每十年约丢3-8%。','老年健康的隐形窃贼。','special'],
  ['pelvic-floor','盆底肌','Pelvic Floor','承托盆腔脏器的深层肌群,孕产后需优先恢复,弱化会致漏尿。','身体底层的吊床。','special'],
  ['hypoglycemia','低血糖','Hypoglycemia','血糖过低引发心慌冷汗头晕,运动叠加降糖药时风险升高。','身体的油量警报。','special'],
  ['heat-illness','热射病','Heat Stroke','重度中暑:体温调节失控、皮肤发烫停止出汗,可危及生命的急症。','高温天的头号杀手。','intro'],
  ['acclimatization','热适应','Heat Acclimatization','连续多日在热环境中循序训练后,出汗与体温调节逐步适应。','身体的气候调节器。','intro'],
  ['fascia','筋膜','Fascia','包裹肌肉的结缔组织网,紧绷粘连会限制活动并产生不适。','肌肉的紧身衣。','recovery'],
  ['foam-roller','泡沫轴','Foam Rolling','用自身体重在轴上滚动按压,放松筋膜与肌肉的恢复工具。','自带的按摩师。','recovery'],
